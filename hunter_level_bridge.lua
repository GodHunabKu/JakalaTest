quest hunter_level_bridge begin
    ...
    -- ============================================================
    -- STATE WITH EVENT HANDLERS ONLY
    -- ============================================================
    ...
    state start begin
        ...
        when hunter_update_timer.timer begin
            ...
            -- hunter_level_bridge.send_player_data() ora viene chiamato solo da /hunter_open
            -- hunter_level_bridge.send_timers() ora viene chiamato solo da /hunter_open
            -- hunter_level_bridge.send_event() ora viene chiamato solo da /hunter_open
        end
