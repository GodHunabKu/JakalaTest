...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php print $shop_url; ?>assets/css/shop-one-c.css" />
    <link rel="stylesheet" href="<?php print $shop_url; ?>assets/css/item-page-c.css">
    <!-- Enhancements CSS - Performance, Accessibility, Responsive -->
    <link rel="stylesheet" href="<?php print $shop_url; ?>assets/css/enhancements-c.css">
    <link rel="stylesheet" href="<?php print $shop_url; ?>assets/css/confirm-modal.css">
    <link rel="stylesheet" href="<?php print $shop_url; ?>assets/css/alerts.css">
    <!-- Admin Panel CSS - Caricato solo per admin -->
    <?php if(is_loggedin() && web_admin_level()>=9) { ?>
    <link rel="stylesheet" href="<?php print $shop_url; ?>assets/css/admin-panel-c.css">
    <?php } ?>
...
<script src="<?php print $shop_url; ?>assets/js/shop-one-j5.js"></script>
<!-- Enhanced JavaScript - Performance & Accessibility -->
<script src="<?php print $shop_url; ?>assets/js/shop-enhanced-j.js" defer></script>
